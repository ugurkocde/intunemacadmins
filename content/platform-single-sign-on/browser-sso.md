...
1. You can [download the mobileconfig file here](../.gitbook/assets/PSSO/PSSO_GoogleChrome.mobileconfig). Right click and select "Save as ..." to save it locally on your device.
...
1. You can [download the preference file here](../.gitbook/assets/PSSO/PSSO_MozillaFirefox.plist). Right click and select "Save as ..." to save it locally on your device.
2. Go to the [Intune Portal](https://intune.microsoft.com/#view/Microsoft_Intune_DeviceSettings/DevicesMacOsMenu/~/configuration) and sign in.
3. Select **Create -> New Policy**.
4. Select **Templates** from Profile type.
