...
# Overview
After meeting the [prerequisites](/src/content/docs/Intune Starting Guide/Getting_Started_With_Prerequisites.md) we turn over to the setup of the tenant and equipment of policies & apps.
