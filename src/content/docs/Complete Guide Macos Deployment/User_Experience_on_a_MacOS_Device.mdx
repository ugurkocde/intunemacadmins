...
description: Explore the user experience during MacOS device enrollment with Apple Business Manager and Intune. This visual guide walks through the setup process, including Wi-Fi configuration and Company Portal setup.
sidebar:
  order: 7
---
...
Now enter your local user password or use touch id![UX](/src/assets/CompleteGuide/image-199.webp)
