...
![MAU](../.gitbook/assets/MAU/mau-1.png)
...
![MAU](../.gitbook/assets/MAU/mau-2.png)
...
![MAU](../.gitbook/assets/MAU/mau-3.png)
...
![MAU](../.gitbook/assets/MAU/mau-4.png)
...
{% hint style="info" %}Users will receive notifications about the upcoming deadline and can temporarily postpone the updates from being installed. But once the deadline is reached, any applications the user has open will be closed and the updates applied.{% endhint %}
