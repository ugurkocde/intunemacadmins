    ...
    starlight({
      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            "baselinesettings/import",
            "baselinesettings/contribute",
            {
              label: "Settings Overview",
              items: [
                "baselinesettings/settingsoverview",
                "baselinesettings/platformsso",
                "baselinesettings/antivirusconfiguration",
                "baselinesettings/mdeconfiguration",
                "baselinesettings/accountsandlogin",
                "baselinesettings/restrictions",
                "baselinesettings/filevault",
                "baselinesettings/gatekeeper",
                "baselinesettings/mauconfiguration",
                "baselinesettings/edgepasswordmanagement",
                "baselinesettings/edgesecurity",
                "baselinesettings/edgeextensions",
                "baselinesettings/edgeprofilessigninsync",
                "baselinesettings/edgeupdates",
                "baselinesettings/officeconfiguration",
                "baselinesettings/onedriveserviceandaccess",
                "baselinesettings/onedriveknownfoldermove",
                "baselinesettings/updates",
              ],
            },
          ],
        },
